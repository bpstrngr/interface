 import {note,compose,buffer,infer,refer,drop,crop,compound,exit,tether} from "./Blik_2023_inference.js";
...
{return compose.call
(this,"toString",[".",request.path].flat().slice(0,-1).join("/"),modularise,"namespace",serialize
);
}
 };
